...
//!! Below is signalr version for chat service
...
export class ChatService {
   ...
   private  connection: any = new signalR.HubConnectionBuilder().withUrl(environment.apiURL+"/chatsocket") //!!fix /chatsocket to match api endpoint
                                         .configureLogging(signalR.LogLevel.Information)
                                         .build();
   readonly POST_URL = environment.apiURL+"/chat/send" //!! fix this url enpoint to match api endpoint
